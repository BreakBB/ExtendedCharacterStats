...
local meleeConfigTranslations = {
    ...
    ["Shows/Hides the glancing chance against enemies on same level."] = {
        ...
        ["frFR"] = "Affiche/cache le chance de coup dévié contre un ennemi du même niveau.",
    ...
    ["Glancing Blow Chance Boss"] = {
        ...
        ["frFR"] = "Chance de coup dévié (Boss)",
        ["zhCN"] = "对Boss的偏斜打击几率",
    ...
    ["Shows/Hides the glancing chance against boss enemies (+3 Level)."] = {
        ...
        ["frFR"] = "Affiche/cache le chance de coup dévié contre un boss de 3 niveaux supérieurs.",
    ...
    ["Shows/Hides the damage reduction against enemies on the same level."] = {
        ...
        ["frFR"] = "Affiche/cache les dégâts du coup dévié contre un ennemi du même niveau.",
    ...
    ["Glancing Blow Damage Boss"] = {
        ...
        ["frFR"] = "Dégâts du coup dévié (Boss)",
        ["zhCN"] = "对Boss的偏斜打击伤害",
    ...
    ["Shows/Hides the damage reduction against boss enemies (+3 Level)."] = {
        ...
        ["frFR"] = "Affiche/cache les dégâts du coup dévié contre un boss de 3 niveaux supérieurs.",
    ...
    ["Melee Glance Values"] = {
        ...
        ["frFR"] = "Valeurs de coup dévié en mêlée",
        ["zhCN"] = "近战偏斜值",
    ...
    ["Shows/Hides all glancing blow stats"] = {
        ...
        ["frFR"] = "Affiche/cache toutes les statistiques de coups déviés",
        ["zhCN"] = "显示/隐藏所有偏斜打击统计",
