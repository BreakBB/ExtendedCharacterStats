...
_CreateStatInfos = function()
    ...
    if ECS.IsWotlk then
        ...
        _CreateStatInfo(
                ...
                spellBonus.holyDmg,
                spellBonus.holyCrit,
                spellBonus.holyHitBonus,
                spellBonus.holyMissChance,
                spellBonus.holyMissChanceBoss,
                spellBonus.natureDmg,
                spellBonus.natureCrit,
                spellBonus.natureHitBonus,
                spellBonus.natureMissChance,
                spellBonus.natureMissChanceBoss,
                spellBonus.physicalDmg,
                spellBonus.physicalCrit,
                spellBonus.physicalHitBonus,
