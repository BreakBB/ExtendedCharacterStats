...
dataFunctionRefs = {
    ...
    ["PhysicalDmg"] = function() return Data:GetSpellPower(Data.PHYSICAL_SCHOOL) end,
    ["HolyDmg"] = function() return Data:GetSpellPower(Data.HOLY_SCHOOL) end,
    ["FireDmg"] = function() return Data:GetSpellPower(Data.FIRE_SCHOOL) end,
    ["NatureDmg"] = function() return Data:GetSpellPower(Data.NATURE_SCHOOL) end,
    ["FrostDmg"] = function() return Data:GetSpellPower(Data.FROST_SCHOOL) end,
    ["ShadowDmg"] = function() return Data:GetSpellPower(Data.SHADOW_SCHOOL) end,
    ["ArcaneDmg"] = function() return Data:GetSpellPower(Data.ARCANE_SCHOOL) end,
