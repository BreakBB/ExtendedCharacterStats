...
Data.Aura = {
    AllowCastingManaRegeneration = {
        [6117] = (IsWotlk and 0.5 or 0.3), -- Mage Armor rank 1
        [12051] = 1, -- Evocation
        [15271] = (IsWotlk and 0.83 or 0.5), -- Spirit Tap
        [18371] = 0.5, -- Soul Siphon
        [22782] = (IsWotlk and 0.5 or 0.3), -- Mage Armor rank 2
        [22783] = (IsWotlk and 0.5 or 0.3), -- Mage Armor rank 3
        [23684] = 1, -- Aura of the Blue Dragon
        [27125] = (IsWotlk and 0.5 or 0.3), -- Mage Armor rank 4
        [29166] = 1, -- Innervate
        [32932] = 1, -- Sun Shield
    ...
    CritReductionAll = {
        ...
        [30708] = (IsWotlk and -3 or nil), -- totem of wrath
    ...
    CritReductionSpell = {
        [17794] = (IsWotlk and -1 or nil), -- Shadow Mastery 1/5
        [17797] = (IsWotlk and -3 or nil), -- Shadow Mastery 2/5
        [17798] = (IsWotlk and -2 or nil), -- Shadow Mastery 3/5
        [17799] = (IsWotlk and -4 or nil), -- Shadow Mastery 4/5
        [17800] = (IsWotlk and -5 or nil), -- Shadow Mastery 5/5
        [22959] = (IsWotlk and -5 or nil), -- Improved Scorch
    },
    IsFeralForm = {
        [768] = true, -- Cat Form
        [5487] = true, -- Bear Form
    ...
    MP5 = {
        ...
        [18194] = (IsWotlk and 10 or 8), -- Mana Regeneration
        [21172] = 75, -- Grip of Command
        [21174] = 50, -- Aura of Battle
        [22734] = 700, -- drink
        [23698] = 735, -- Alterac Spring Water
        [24363] = (IsWotlk and 15 or 12), -- Mana Regeneration
        ...
        [26475] = 551, -- drink
        [27089] = 240*5, -- Drink
        [28145] = (IsWotlk and 14 or 11), -- Power of the Guardian
        [28509] = (IsWotlk and 20 or 16), -- Greater Mana Regeneration
        [28519] = (IsWotlk and 31 or 25), -- Flask of Mighty Restoration
        [28795] = (IsWotlk and 35 or 28), -- Holy Power
        [28804] = (IsWotlk and 30 or 24), -- Epiphany
        [28820] = (IsWotlk and 19 or 15), -- Lightning Shield
        [28824] = (IsWotlk and 35 or 28), -- Totemic Power
        [29007] = 489, -- Drink
        [29039] = 300, -- Fizzy Energy Drink
        [31036] = (IsWotlk and 56 or 45), -- Verdant Flame
        [31462] = 12, -- Moonwell Restoration
        [32548] = 33, -- Symbol of Hope
        [33265] = (IsWotlk and 10 or 8), -- well fed
        [33736] = 50, -- Water Shield Rank 2 TBC / 8 WOTLK
        [33774] = 735, -- Underspore Pod
        [34291] = 850, -- drink
        [34410] = 10, -- Hellscream's Warsong
        [35095] = (IsWotlk and 26 or 21), -- Enlightenment
        [37656] = (IsWotlk and 95 or 76), -- wisdom
        [38437] = (IsWotlk and 19 or 15), -- Totemic Mastery
        [40568] = (IsWotlk and 12 or 8), -- Unstable Flask of the Elder Only works in Blade's Edge Mountains Plateaus and Gruul's Lair.
        [40582] = (IsWotlk and 12 or 8), -- Unstable Flask of the Elder Only works in Blade's Edge Mountains Plateaus and Gruul's Lair.
        [41605] = (IsWotlk and 31 or 25), -- Mighty Restoration of Shattrath Only active in Tempest Keep, Serpentshrine Cavern, Caverns of Time: Mount Hyjal, Black Temple and the Sunwell Plateau.
        [41610] = (IsWotlk and 31 or 25), -- Mighty Restoration of Shattrath Only active in Tempest Keep, Serpentshrine Cavern, Caverns of Time: Mount Hyjal, Black Temple and the Sunwell Plateau.
        [42308] = 1250, -- brain food
        [42312] = 1200, -- Brain Food
        [43154] = 489, -- Drink
        [43182] = 428*5, -- Drink
        [43183] = 640*5, -- Drink
        [43742] = (IsWotlk and 28 or 22), -- Grace of the Naaru
        ...
        [46386] = (IsWotlk and 83 or 66), -- Luminous Bluetail
        [46755] = 240, -- drink
    ...
    MP5Tooltip = {
        [5677] = (IsWotlk and 5/2 or nil), -- Mana Spring rank 1
        [10491] = (IsWotlk and 5/2 or nil), -- Mana Spring rank 2
        [10493] = (IsWotlk and 5/2 or nil), -- Mana Spring rank 3
        [10494] = (IsWotlk and 5/2 or nil), -- Mana Spring rank 4
        [19742] = ((not IsClassic) and 1 or nil), -- Blessing of Wisdom rank 1
        [19850] = ((not IsClassic) and 1 or nil), -- Blessing of Wisdom rank 2
        [19852] = ((not IsClassic) and 1 or nil), -- Blessing of Wisdom rank 3
        [19853] = ((not IsClassic) and 1 or nil), -- Blessing of Wisdom rank 4
        [19854] = ((not IsClassic) and 1 or nil), -- Blessing of Wisdom rank 5
        [25290] = ((not IsClassic) and 1 or nil), -- Blessing of Wisdom rank 6
        [25569] = (IsWotlk and 5/2 or nil), -- Mana Spring rank 5
        [25894] = ((not IsClassic) and 1 or nil), -- Greater Blessing of Wisdom rank 1
        [25918] = ((not IsClassic) and 1 or nil), -- Greater Blessing of Wisdom rank 2
    ...
    PercentageMp5 = {
        [12051] = ((not IsClassic) and 0.15/2*5 or nil), -- Evocation
        [18792] = (IsClassic and 0.02/4 or 0.03/4)*5, -- Fel Energy
        [24355] = 0.02*5, -- Drink
        [24707] = 0.03*5, -- Food
        [25990] = 0.05*5, -- Graccu's Mince Meat Fruitcake
        [26263] = (IsClassic and 0.04 or 0.03)*5, -- Dim Sum
    ...
    PeriodicallyGiveManaTooltip = {
        ...
        [19853] = (IsClassic and 1 or nil), -- Blessing of Wisdom rank 4
    ...
    SpellCrit = {
        [24907] = ((not IsClassic) and 5 or nil), -- Moonkin Aura
